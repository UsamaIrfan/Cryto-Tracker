...
/*
 ...
 JSON RESPONSE:
 {
   ...
   "sentiment_votes_up_percentage": 83.74,
   "sentiment_votes_down_percentage": 16.26,
   "watchlist_portfolio_users": 1380581,
   "market_cap_rank": 1,
   "coingecko_rank": 1,
   ...
   "status_updates": [],
   "last_updated": "2023-11-26T17:28:06.206Z"
 }
...
struct CoinDetailModel: Codable {
    ...
    let localization, description: Description?
    let links: Links?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case localization, description, links
    }
