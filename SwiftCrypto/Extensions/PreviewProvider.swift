...
class DeveloperPreview {
    ...
    let stat = StatisticsModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 24.53)
    let stat2 = StatisticsModel(title: "Total Volume", value: "$1.2Tr")
    let stat3 = StatisticsModel(title: "Portfolio Value", value: "$50.4K", percentageChange: -12.34)
