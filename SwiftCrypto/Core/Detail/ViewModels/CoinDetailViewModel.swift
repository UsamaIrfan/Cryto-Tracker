...
//  SwiftCrypto
//
//  Created by Map Mac on 26/11/2023.
//
...
class CoinDetailViewModel: ObservableObject {
    ...
    private func mapDataToStatistics(coinDetails: CoinDetailModel?, coinModel: CoinModel) -> (overview: [StatisticsModel], additional: [StatisticsModel]) {
    ...
    private func createOverviewArray(coinModel: CoinModel) -> [StatisticsModel] {
        ...
        let pricePercentChange = coinModel.priceChangePercentage24H ?? 0.00
    ...
    private func createAdditionalArray(coinDetails: CoinDetailModel?, coinModel: CoinModel) -> [StatisticsModel] {
        ...
        let marketCapPercentChange = coinModel.marketCapChangePercentage24H
        let marketCapPercentStat = StatisticsModel(title: "24h Market Cap Change", value: marketCapChange, percentageChange: marketCapPercentChange)
        ...
        return [highStat, lowStat, priceChangeStat, marketCapPercentStat, blockTimeStat, hashingStat]
    }
